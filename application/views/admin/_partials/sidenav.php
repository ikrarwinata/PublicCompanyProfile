        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="admin/Agenda/create" class="nav-link">
                  <i class="fa fa-plus nav-icon text-success"></i>
                  <p>Tambah Agenda</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="admin/Agenda/semua" class="nav-link">
                  <i class="fa fa-list nav-icon"></i>
                  <p>Semua Agenda</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="admin/Agenda/terlewati" class="nav-link">
                  <i class="fa fa-list nav-icon"></i>
                  <p>Agenda Telah Lewat</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="admin/Agenda/akandatang" class="nav-link">
                  <i class="fa fa-list nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="admin/Komentar/index" class="nav-link">
              <i class="nav-icon fa fa-inbox text-primary"></i>
              <p>Inbox</p>
            </a>
          </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="admin/User/create" class="nav-link">
                  <i class="fa fa-plus nav-icon text-warning"></i>
                  <p>Tambah Akun</p>
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="admin/User/member" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Akun Anggota</p>
                </a>
              </li>
              ...
              <!-- <li class="nav-item">
                <a href="admin/User/leader" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Akun Pimpinan</p>
                </a>
              </li> -->
          ...
          <li class="nav-item">
            <a href="admin/Admin/laporan" class="nav-link">
              <i class="nav-icon fa fa-reply text-purple"></i>
              <p>Laporan</p>
            </a>
          </li>
