        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/Agenda/create'),'Tambah Agenda', 'class="btn btn-primary"'); ?>
            </div>
				...
				foreach ($agenda_data as $agenda)
				{
					...
					<tr>
						...
						<td style="text-align:center" width="200px">
							<a href="admin/Agenda/read/<?php echo $agenda->id ?>" class="btn btn-sm btn-default" title="Lihat detail agenda"><i class="fa fa-search"></i></a>
							<a href="admin/Agenda/update/<?php echo $agenda->id ?>" class="btn btn-sm btn-primary" title="Ubah agenda"><i class="fa fa-edit"></i></a>
							<a href="admin/Agenda/delete/<?php echo $agenda->id ?>" class="btn btn-sm btn-danger" title="Hapus agenda" onclick="return confirm('Anda yakin ingin menghapus agenda kegiatan ini ?')"><i class="fa fa-trash"></i></a>
						</td>
					</tr>
					<?php
				}
