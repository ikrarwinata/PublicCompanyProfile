		...
		<div class="row">
			<div class="col-lg-6">
				<div class="img-faqs w-100">
					<div class="img mb-4 mb-sm-0" style="background-image:url(assets/public_home/images/PT-ISS-Indonesia-.jpg);">
					</div>
					<div class="img img-2 mb-4 mb-sm-0" style="background-image:url(assets/public_home/images/banner1.jpeg);">
					</div>
				</div>
			</div>
				...
				<div id="accordion" class="myaccordion w-100" aria-multiselectable="true">
					<div class="card">
						...
						<div class="collapse show" id="collapseOne" role="tabpanel" aria-labelledby="headingOne">
							<div class="card-body py-3 px-0 text-center">
								<h4><strong>RIYAN HIDAYAH</strong></h4>
								<h5>NIM : 190101176</h5>
								<h5>KELAS : 19SIB1</h5>
							</div>
						</div>
					...
					<div class="card">
						<div class="card-header p-0" id="headingF" role="tab">
							<h2 class="mb-0">
								<button href="#collapseF" class="d-flex py-3 px-4 align-items-center justify-content-between btn btn-link" data-parent="#accordion" data-toggle="collapse" aria-expanded="false" aria-controls="collapseThree">
									<p class="mb-0">Sejarah</p>
									<i class="fa" aria-hidden="true"></i>
								</button>
							</h2>
						</div>
						<div class="collapse" id="collapseF" role="tabpanel" aria-labelledby="headingF">
							<div class="card-body py-3 px-0">
