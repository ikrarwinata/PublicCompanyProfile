...
<body>
  ...
  s25.3-11.3,25.3-25.3C125.3,29,115.9,18.5,103.8,16.7z" />
		...
		<div class="message" style="background-color: gray; opacity: 0.8; min-height: 25px; height: 25px; min-width: 250px; width: 250px; vertical-align: middle; border-radius: 25px; padding: 5px" align="center">
			<a href="home">Back to home</a>
		</div>
	</div>
	<!--copyright-->
	<div class="copy-wthree">
		<p>© <?php echo date("Y") ?> 5H0UT5. All Rights Reserved.
		</p>
	</div>
	<!--//copyright-->
</body>
